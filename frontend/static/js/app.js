...
class ImageColorizationApp {
    ...
    initializeElements() {
        ...
        this.labImage = document.getElementById('labImage');
    ...
    displayResults(images) {
        ...
        if (images.lab) {
            this.labImage.src = images.lab;
            this.labImage.alt = 'LAB Colorized Image';
        }
        
        if (images.rgb_colorized) {
            this.rgbImage.src = images.rgb_colorized;
            this.rgbImage.alt = 'RGB Colorized Image';
        }
...
function downloadResults() {
    const images = [
        ...
        { id: 'labImage', name: 'lab_colorized.png' },
        { id: 'rgbImage', name: 'rgb_colorized.png' }
    ];
